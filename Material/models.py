...
def uploadCloudinaryFileName(instance):
    print()
    print()
    fileNameCloudinary=str(instance.material).split('-')[0].split('Material: ')[1].split(' ')[0]
    #print(fileNameCloudinary)
...
class Material(models.Model):
    ...
    DESPERFECTOS_MODERADOS = 3#"Desperfectos moderados"
    DESPERFECTOS_GRAVES = 4#"Desperfectos graves"
    ESTADO_MATERIAL = (
